...
namespace WizLib_DataAccess.Migrations
{
    ...
    [Migration("20221026210835_AddOneToManyBookAndPublisherRelation")]
            ...
            modelBuilder.Entity("WizLib_Model.Models.Book", b =>
                {
                    ...
                    b.Property<int>("PublishcperPublisher_Id")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PublishcperPublisher_Id");
            ...
            modelBuilder.Entity("WizLib_Model.Models.Book", b =>
                {
                    ...
                    b.HasOne("WizLib_Model.Models.Publisher", "Publishcper")
                        .WithMany("Books")
                        .HasForeignKey("PublishcperPublisher_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("BookDetail");

                    b.Navigation("Publishcper");
                });
